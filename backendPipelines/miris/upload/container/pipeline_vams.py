...
def run(stage: PipelineStage, inputMetadataS3Location: str = '', localTest: bool = False) -> PipelineStage:
    """
    ...
    inputMetadataObject = {}
    if(isinstance(inputMetadataS3Location,str) and inputMetadataS3Location != ''):
        try:
            inputMetadataObject = json.loads(inputMetadataS3Location)
        except:
